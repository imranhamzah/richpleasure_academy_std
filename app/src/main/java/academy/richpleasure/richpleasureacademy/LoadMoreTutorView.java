...
public class LoadMoreTutorView {
    ...
    public LoadMoreTutorView(InfinitePlaceHolderView loadMoreView, List<SubjectListInfo> subjectList) {
    ...
    private void onLoadMore(){
        ...
        new LoadMoreTutorView.ForcedWaitedLoading();
    }
        ...
        public void run() {
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                ...
                public void run() {
                    ...
                    for (int i = count - 1;
                         i < (count - 1 + LoadMoreTutorView.LOAD_VIEW_SET_COUNT) && mSubjectList.size() > i;
                         i++) {
